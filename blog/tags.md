      ...
      <li>
        <article class="h-entry">
          ...
          <h6>
            ...
            Location:&nbsp; {% if post.location.text %}<span class="h-geo p-location"><data class="p-latitude" value="{{ post.location.latitude }}"></data><data class="p-longitude" value="{{ post.location.longitude }}"></data><a href="https://www.google.ca/maps/place/{{ post.location.latitude }},{{ post.location.longitude }}" target="_blank" title="{{ post.location.latitude }}, {{ post.location.longitude }}">{{ post.location.text }}</a></span>{% else %}N/A{% endif %}
          </h6>
