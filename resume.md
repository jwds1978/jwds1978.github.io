...
<div class="h-resume">
  ...
  <div class="h-card h-event p-experience">
    <p>
      ...
      (<time class="dt-duration" datetime="P3Y8M">3 Years, 8 Months</time>)
    </p>
  </div>
  <div class="h-card h-event p-experience">
    <p>
  ...
  <div class="h-card h-event p-experience">
    <p>
      ...
      (<time class="dt-duration" datetime="P4Y">4 Years</time>)
    </p>
  </div>
  <div class="h-card h-event p-experience">
    <p>
      ...
      (<time class="dt-duration" datetime="P1Y">1 Year</time>)
    </p>
  </div>
  <div class="h-card h-event p-experience">
    <p>
